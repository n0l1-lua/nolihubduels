--[[
    Noli HUB DUELS 💜 (SILENT HUB INTEGRATION – FIXED SPEED CONFLICT)
...
-- ==============================================================================
-- 1. NoliHUB GUI LIBRARY (ADAPTIVE) – unchanged
-- ==============================================================================
local NoliGuiLib = {}
NoliGuiLib.__index = NoliGuiLib
...
function NoliGuiLib:CreateGui(titleText)
    local self = setmetatable({}, NoliGuiLib)
    if CoreGui:FindFirstChild("NoliHub") then CoreGui["NoliHub"]:Destroy() end
    if PlayerGui:FindFirstChild("NoliHub") then PlayerGui["NoliHub"]:Destroy() end
    
    self.ScreenGui = Instance.new("ScreenGui")
    self.ScreenGui.Name = "NoliHub"
...
function NoliGuiLib:AddGridButton(text, callback, row, col)
...
function NoliGuiLib:AddCenteredButton(text, callback, row, width)
    width = width or 0.33
    local btn = Instance.new("TextButton", self.Frame)
    btn.Size = UDim2.new(width, 0, 0, 35)
...
function NoliGuiLib:AddLabel(text, yPos)
...
function NoliGuiLib:AddTextBox(defaultText, yPos, callback)
...
function NoliGuiLib:AddProgressBar(yPos)
...
-- ==============================================================================
-- 9. ANTI RAGDOLL (Noli version) – unchanged
-- ==============================================================================
local Frozen = false
...
local myGui = NoliGuiLib:CreateGui("Noli HUB DUELS 💜")
...
print("N0L1 DUELS Loaded (Noli Hub & Instant Grab – speed conflict fixed)")
